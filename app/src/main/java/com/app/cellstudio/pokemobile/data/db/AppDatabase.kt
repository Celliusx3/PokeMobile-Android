...
import com.app.cellstudio.pokemobile.data.db.converter.PokemonTCGCardConverter
...
@Database(entities = [ PokemonTCGCardDatabaseEntity::class, PokemonTCGSetDatabaseEntity::class ], version = 3)
@TypeConverters(PokemonTCGCardConverter::class)
