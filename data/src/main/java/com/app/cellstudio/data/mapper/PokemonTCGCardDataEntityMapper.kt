...
class PokemonTCGCardDataEntityMapper {
    ...
    companion object {
        fun create (pokemonTCGCardDataModel: PokemonTCGCardDataResponseModel.PokemonTCGCardDataModel): PokemonTCGCard {
            val ability = PokemonTCGCardDataEntityMapper.createAbility(pokemonTCGCardDataModel.ability)
            ...
            if (pokemonTCGCardDataModel.attacks != null) {
                pokemonTCGCardDataModel.attacks.mapTo(attacks) { PokemonTCGCardDataEntityMapper.createAttack(it) }
            }

            if (pokemonTCGCardDataModel.weaknesses != null) {
                pokemonTCGCardDataModel.weaknesses.mapTo(weaknesses) { PokemonTCGCardDataEntityMapper.createWeakness(it) }
            }
